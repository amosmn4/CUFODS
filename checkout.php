                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="payment-option">
                                        ...
                                        <li>
                                            ...
                                            <li>
                                                <label class="custom-control custom-radio  m-b-10">
                                                    <input name="mod"  type="radio" value="Mpesa" class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Mpesa <img src="images/mpesa.png" alt="" width="30"></span> </label>
                                            </li>
                                            <li>
                                                <label class="custom-control custom-radio  m-b-10">
                                                    <input name="mod"  type="radio" value="Visa" class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Visa <img src="images/mastercard.png" alt="" width="20"></span> </label>
                                            </li>
                                        </ul
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-3 payment-options color-gray">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="#"> <img src="images/mpesa.png" alt="mpesa"> </a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Chuka University, Chuka</p>
                                    <h5>Phone: 0000</a></h5> </div>
